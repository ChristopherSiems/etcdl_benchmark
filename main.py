...
if __name__ == '__main__':
    ...
    for system, configs in config.items():
        for cfg in configs:
            ...
            fast_path_writes: int = config_get(cfg, 'fast_path_writes')
